...
public class Starfield extends ApplicationAdapter {
    ...
    public void initStars(float density) {
        ...
        int numberOfStars = Math.round(screenHeight*screenWidth*density);
        ...
        {
            int x = randomGen.nextInt(screenHeight);
            int y = randomGen.nextInt(screenWidth);

            stars.add(new Vector2(y,x));
        }
